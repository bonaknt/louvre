...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'mk_louvre.billet' => 'getMkLouvre_BilletService',
            'mk_louvre.reference' => 'getMkLouvre_ReferenceService',
            'mk_louvre.tarif' => 'getMkLouvre_TarifService',
            'mk_louvre.validator.blocage' => 'getMkLouvre_Validator_BlocageService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('JO5OdLdMbh', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aUg908z268', 0, 'RR52wl7BcjFZ98M3+GY0FL', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'louvre', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\MK\\LouvreBundle\\Entity'))), 'MK\\LouvreBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('MKLouvreBundle' => 'MK\\LouvreBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_051b201a9f54de435bf8d80d9ebeb4599f5c545df27561e6583a5652a8a9a506');
    ...
    /**
     * Gets the 'mk_louvre.billet' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MK\LouvreBundle\Billet\MKBillet A MK\LouvreBundle\Billet\MKBillet instance
     */
    protected function getMkLouvre_BilletService()
    {
        return $this->services['mk_louvre.billet'] = new \MK\LouvreBundle\Billet\MKBillet();
    }

    /**
     * Gets the 'mk_louvre.reference' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MK\LouvreBundle\Reference\MKReference A MK\LouvreBundle\Reference\MKReference instance
     */
    protected function getMkLouvre_ReferenceService()
    {
        return $this->services['mk_louvre.reference'] = new \MK\LouvreBundle\Reference\MKReference();
    }

    /**
     * Gets the 'mk_louvre.tarif' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MK\LouvreBundle\CalculTarif\MKTarif A MK\LouvreBundle\CalculTarif\MKTarif instance
     */
    protected function getMkLouvre_TarifService()
    {
        return $this->services['mk_louvre.tarif'] = new \MK\LouvreBundle\CalculTarif\MKTarif();
    }

    /**
     * Gets the 'mk_louvre.validator.blocage' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MK\LouvreBundle\Validator\BlocageValidator A MK\LouvreBundle\Validator\BlocageValidator instance
     */
    protected function getMkLouvre_Validator_BlocageService()
    {
        return $this->services['mk_louvre.validator.blocage'] = new \MK\LouvreBundle\Validator\BlocageValidator($this->get('request_stack'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('m.konatedev@gmail.com');
        $a->setPassword('Sounnahforlife987');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MK\\LouvreBundle/Resources/views'), 'MKLouvre');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('58ee5e66b49b4952a18a5d3a35694cd21b86cfdb');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\ExpressionValidator' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email', 'security.validator.user_password' => 'security.validator.user_password', 'Symfony\\Component\\Security\\Core\\Validator\\Constraints\\UserPasswordValidator' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'Symfony\\Bridge\\Doctrine\\Validator\\Constraints\\UniqueEntityValidator' => 'doctrine.orm.validator.unique', 'mk_louvre_blocage' => 'mk_louvre.validator.blocage', 'MK\\LouvreBundle\\Validator\\BlocageValidator' => 'mk_louvre.validator.blocage')));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HvCjTKRBKn', 0, 'RR52wl7BcjFZ98M3+GY0FL', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('593ae52a54bb53.52111602')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'MKLouvreBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MK\\LouvreBundle'),
                    'namespace' => 'MK\\LouvreBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MKLouvreBundle' => 'MK\\LouvreBundle\\MKLouvreBundle',
            ...
            'secret' => '58ee5e66b49b4952a18a5d3a35694cd21b86cfdb',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '58ee5e66b49b4952a18a5d3a35694cd21b86cfdb',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'm.konatedev@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Sounnahforlife987',
